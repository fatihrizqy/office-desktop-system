...
@section('container')
    ...
    <h2 class="m-100">Department Menu</h2>
    <form action="{{route('searchDepartmentPost')}}" >
        ...
        <div class="row">
            <div class="col-md-12">
                    <div class="card-body">
                        <a href="{{ route('createDepartment') }}" class="btn btn-md btn-success my-3">Tambah</a>
                            ...
                            <tbody>
                              @forelse ($department as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->countryName }}</td>
                                    <td>
                                        <a href="{{ url('department/edit/'.$d->DepartementId) }}" class="btn btn-mdl btn-primary">Edit</a>
